...
** #You can help evolve Eclipse Collection and add the features you need#
* Design goals
...
== Primitive Set - Set Operations
[example]
--
[source,java,linenums,highlight=3..7]
----
