...
@Service
public class EcReconcilerServiceCustomHashingStrategyImpl implements ReconcilerService
{
    private static final Logger LOGGER = LoggerFactory.getLogger(EcReconcilerServiceCustomHashingStrategyImpl.class);
    ...
    private static class ReservationHashingStrategy implements HashingStrategy<ReconRecord>
    {
        @Override
        public int computeHashCode(ReconRecord object)
        {
            Reservation reservation = (Reservation) object;
            return Objects.hashCode(reservation.getFirstName()) * 31 +
                    Objects.hashCode(reservation.getLastName()) * 31 +
                    Objects.hashCode(reservation.getDestination()) * 31 +
                    Objects.hashCode(reservation.getTransportType());
        }
